 ...
 * ```
 */
export const routePath = (c: Context): string =>
	matchedRoutes(c)[c.req.routeIndex].path;
 ...
 * ```
 */
export const baseRoutePath = (c: Context): string =>
	matchedRoutes(c)[c.req.routeIndex].basePath;
