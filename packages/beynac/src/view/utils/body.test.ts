...
describe("Parse Body Util", () => {
	...
	describe("Return type", () => {
		...
		it("{all: boolean}", async () => {
			expectTypeOf(
				(await parseBody(req, { all: !!Math.random() }))["key"],
			).toEqualTypeOf<string | File | (string | File)[]>();
		});
		...
		it("{dot: boolean}", async () => {
			expectTypeOf(
				(await parseBody(req, { dot: !!Math.random() }))["key"],
			).toEqualTypeOf<string | File | RecursiveRecord<string, string | File>>();
		});

		it("{all: true, dot: true}", async () => {
			expectTypeOf(
				(await parseBody(req, { all: true, dot: true }))["key"],
			).toEqualTypeOf<
				| string
				| File
				| (string | File)[]
...
describe("BodyData", () => {
	...
	it("{all: true, dot: true}", async () => {
		expectTypeOf(
			({} as BodyData<{ all: true; dot: true }>)["key"],
		).toEqualTypeOf<
			| string
			| File
			| (string | File)[]
	...
	it("{all: boolean, dot: boolean}", async () => {
		expectTypeOf(
			({} as BodyData<{ all: boolean; dot: boolean }>)["key"],
		).toEqualTypeOf<
			| string
			| File
			| (string | File)[]
